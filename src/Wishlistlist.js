...
const Wishlistlist = ({course}) => {
    const { removcoursewishlist} = useContext(CoursesContext);
            ...
            <div className="courses-images">
                ...
                <div className="courses-option dropdown">
                    ...
                    <ul id="dropdown-men" className={`dropdown-menu ${active ? "show" : null}`}>
                        <li><a onClick={e => {removcoursewishlist(course.id); toggleclassName();}} href="!#"><i className="icofont-delete"></i>Remove Wishlist</a></li>
                    </ul>
                </div>
            </div>
