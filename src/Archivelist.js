...
const Archivelist = ({course}) => {
    const {removcoursearchivelist} = useContext(CoursesContext);
            ...
            <div className="courses-images">
                ...
                <div className="courses-option dropdown">
                    ...
                    <ul id="dropdown-men" className={`dropdown-menu ${active ? "show" : null}`}>
                        <li><a onClick={e => {removcoursearchivelist(course.id); toggleclassName();}} href="#"><i className="icofont-delete"></i>Remove Archive</a></li>
                    </ul>
                </div>
            </div>
